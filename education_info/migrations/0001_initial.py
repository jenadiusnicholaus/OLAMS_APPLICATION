    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '1: TBL post 4 type',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '11. Master Awards',
        ...
        migrations.CreateModel(
            name='TblSponsorDetails',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('sponsored_ed_type', models.CharField(choices=[(0, 'POST fORM fOUR SPONSORSHIP'), (1, 'fORM fOUR SPONSORSHIP')], max_length=20, null=True)),
                ('sponsor_contact_person_full_name', models.CharField(max_length=30, null=True)),
                ('sponsor_contact_person_phone_nunber', models.CharField(max_length=30, null=True)),
                ('sponsor_contact_person_address', models.CharField(max_length=40, null=True)),
                ('updated_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('applicant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ed_tbl_sps_set', to='applicantProfile.tblappprofile')),
            ],
            options={
                'verbose_name': '3: TBL Sponsor',
                'verbose_name_plural': '3: TBL Sponsor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pst4ed', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ed_post_4_eduction_type_set', to='education_info.tblpost4eductiontype')),
            ],
            options={
                'verbose_name': '2: TBL Education',
                'verbose_name_plural': '2: TBL Education',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '10:TBL Tertiary Education infos',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '5: TBL Eduction Form four infos ',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '4: TBL Education Applicant Attended Schools',
